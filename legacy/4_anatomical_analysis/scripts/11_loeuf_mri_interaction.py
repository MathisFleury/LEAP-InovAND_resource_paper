...
#
# Inputs (hg19):  df_clusters_complete_kmeans.csv, MRI_ANAT_INOVAND_LEAP_COMBAT.tsv
...
CARRIER_HG38   = os.path.join(
    _lib_dir, "LEAP-InovAND_resource", "legacy", "2_genetic_analysis", "outputs",
...
def load_hg19():
    ...
    df_m = pd.read_csv(MRI_FILE, sep="\t", low_memory=False)
