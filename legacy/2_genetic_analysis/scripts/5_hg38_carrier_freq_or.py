#!/usr/bin/env python3
# =============================================================================
# Carrier Frequencies & Odds Ratios, hg38/GRCh38/gnomAD v2 (legacy --
# superseded by gnomAD v4)
# =============================================================================
# Same analyses as 4_carrier_freq_or_clusters.py but using the GRCh38-based
# carrier annotation file, which includes additional gene lists: metabolic
# and SynGO+ChromEpiTF.
#
...
def main():
    ...
    # Prefer generated file from script 2; fall back to pre-annotated file
