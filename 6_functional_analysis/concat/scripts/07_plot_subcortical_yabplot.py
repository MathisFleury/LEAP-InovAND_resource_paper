...
_BASE_DIR    = Path(os.environ.get('AUTISM_TD_OUTPUT_DIR', _DEFAULT_DIR))
INPUT_DIR    = _BASE_DIR / 'tables'   # reads 01's *_full_data.csv
OUTPUT_DIR   = _BASE_DIR / 'figures'  # writes the yabplot PNGs
