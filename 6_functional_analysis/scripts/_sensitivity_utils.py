...
FMRI_CONN_FILE = Path(__file__).resolve().parents[1] / 'preprocessing' / 'outputs' / 'df_conn_cohort_norm.csv'
ATLAS_FILE = Path(
...
QC_TABLE_PATH = (
    Path('/Users/mfleury/POSTDOC/LIBRAIRY/LEAP-InovAND_resource/'
         '6_functional_analysis/outputs/tables/fmri_qc_per_subject.csv')
)
