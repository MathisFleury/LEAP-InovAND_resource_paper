#!/usr/bin/env python3
# =============================================================================
# 02 - Carrier Frequencies & Odds Ratios by GMM Cluster
# =============================================================================
# Uses cluster assignments from the large multi-dataset GMM analysis
# (eeg_mri-pipeline/.../df_multi_dataset_with_clusters.csv, column Cluster_GMM).
#
...
from _config import (
    ...
    FIGURES_GMM_DIR, TABLES_GMM_DIR,
...
os.makedirs(FIGURES_GMM_DIR, exist_ok=True)
os.makedirs(TABLES_GMM_DIR, exist_ok=True)


def compute_pgs_odds_ratios(df, cluster_col, pgs_traits, palette, reference_group="NT"):
    """PGS odds ratios (top 25% vs bottom 25%) for each cluster vs reference."""
    results = []
    ...
    for cluster_name in clusters:
        ...
        for col in pgs_traits:
            ...
            results.append({
                ...
                "top_25_thresh": top_thresh, "bot_25_thresh": bot_thresh,
...
def main():
    ...
    plot_carrier_frequencies(
        ...
        "gmm_cluster_constraint_freq.pdf", ylim=(0, 1),
        figures_dir=FIGURES_GMM_DIR,
    )
    ...
    compute_and_plot_odds_ratios(
        df, "Cluster_with_NT", COLS_DELLOF_CONSTRAINED,
        PALETTE_CLUSTERS, ORDER_CLUSTERS, LABELS_CONSTRAINED,
        "gmm_cluster_constraint_or.pdf",
        figures_dir=FIGURES_GMM_DIR, tables_dir=TABLES_GMM_DIR,
    )
