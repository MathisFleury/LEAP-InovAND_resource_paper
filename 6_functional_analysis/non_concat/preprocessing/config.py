...
# Covariate policy single-sourced from root config.py (FUNC_* — functional
# uses cohort + mean_fd, unlike the EEG 3-covar set).
#   COMBAT_COVARS  : biological covariates PRESERVED by ComBat (no motion here).
#   REGRESS_COVARS : regressed OUT in step 05, incl. mean_fd for residual motion.
COMBAT_COVARS = _pc.FUNC_COMBAT_COVARS
REGRESS_COVARS = _pc.FUNC_REGRESS_COVARS
