...
# same connectivity file; run_all.sh always sets FMRI_CONN_FILE explicitly, overrides via the FMRI_CONN_FILE env.
...
QC_TABLE_PATH = Path(os.environ.get(
    ...
    '6_functional_analysis/concat/outputs/tables/fmri_qc_per_subject.csv'))
