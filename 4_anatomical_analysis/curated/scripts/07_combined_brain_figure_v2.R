...
# =============================================================================
# Thin wrapper around ../../scripts/13_combined_brain_figure.R: sets the
...
# curated/ tree automatically (the shared script derives them from its
# caller's location).
# =============================================================================
...
shared      <- normalizePath(file.path(section_dir, "..", "scripts", "13_combined_brain_figure.R"))
