#!/usr/bin/env python3
# =============================================================================
# 08 - LOEUF score vs Cortical Thickness + Subcortical Volumes (hg38)
# =============================================================================
# Mirrors script 07 but uses hg38 carrier annotations.
...
#
# hg38 variant types: lof and del (no dellof combined, no missense)
# Subsets: lof_constrained, lof_all, del_constrained, del_all
#
# Input:  carrier_annotations_hg38.tsv (2_genetic_analysis/outputs/tables_hg38)
#         MRI_ANAT_INOVAND_LEAP_COMBAT.tsv
# Output: figures_genetics_hg38/, tables_genetics_hg38/
# =============================================================================
...
OUTPUT_FIGURES = os.path.join(_script_dir, "..", "outputs", "figures_genetics_hg38")
OUTPUT_TABLES  = os.path.join(_script_dir, "..", "outputs", "tables_genetics_hg38")
os.makedirs(OUTPUT_FIGURES, exist_ok=True)
os.makedirs(OUTPUT_TABLES,  exist_ok=True)

LOEUF_COLS = {
    "lof_constrained": [
        "lof_contraint_best_score",
        "lof_hcndddomv6_contraint_best_score",
        "lof_sparksfari1_contraint_best_score",
        "lof_eagle_contraint_best_score",
        "lof_syngo_contraint_best_score",
        "lof_chromepitf_contraint_best_score",
        "lof_metabolic_constraint_genes_best_score",
        "lof_syngo_chromepitf_contraint_best_score",
    ],
    "lof_all": [
        "lof_hcndddomv6_best_score",
        "lof_sparksfari1_best_score",
        "lof_eagle_best_score",
        "lof_syngo_best_score",
        "lof_chromepitf_best_score",
        "lof_metabolic_genes_best_score",
        "lof_syngo_chromepitf_best_score",
    ],
    "del_constrained": [
        "del_constraint_genes_best_score",
        "del_hcndddomv6_xlinked_boyz_constraint_genes_best_score",
        "del_sparksfari1_constraint_genes_best_score",
        "del_eagles_ds_constraint_genes_best_score",
        "del_syngo_constraint_genes_best_score",
        "del_chromepitf_constraint_genes_best_score",
        "del_metabolic_constraint_genes_best_score",
        "del_syngo_chromepitf_constraint_genes_best_score",
    ],
    "del_all": [
        "del_proteinconding_genes_best_score",
        "del_hcndddomv6_xlinked_boyz_genes_best_score",
        "del_sparksfari1_genes_best_score",
        "del_eagles_ds_genes_best_score",
        "del_syngo_genes_best_score",
        "del_chromepitf_genes_best_score",
        "del_metabolic_genes_best_score",
        "del_syngo_chromepitf_genes_best_score",
    ],
}

LOEUF_LABELS = {
    # lof constrained (note: "contraint" typo is in the raw data)
    "lof_contraint_best_score":                  "All (constrained)",
    "lof_hcndddomv6_contraint_best_score":        "HCNDD DOM+XL\n(constrained)",
    "lof_sparksfari1_contraint_best_score":       "SPARK SFARI\n(constrained)",
    "lof_eagle_contraint_best_score":             "EAGLE\n(constrained)",
    "lof_syngo_contraint_best_score":             "SynGO\n(constrained)",
    "lof_chromepitf_contraint_best_score":        "ChromEpiTF\n(constrained)",
    "lof_metabolic_constraint_genes_best_score":  "Metabolic\n(constrained)",
    "lof_syngo_chromepitf_contraint_best_score":  "SynGO+ChromEpiTF\n(constrained)",
    # lof all
    "lof_hcndddomv6_best_score":                  "HCNDD DOM+XL",
    "lof_sparksfari1_best_score":                 "SPARK SFARI",
    "lof_eagle_best_score":                       "EAGLE",
    "lof_syngo_best_score":                       "SynGO",
    "lof_chromepitf_best_score":                  "ChromEpiTF",
    "lof_metabolic_genes_best_score":             "Metabolic",
    "lof_syngo_chromepitf_best_score":            "SynGO+ChromEpiTF",
    # del constrained
    "del_constraint_genes_best_score":                          "All (constrained)",
    "del_hcndddomv6_xlinked_boyz_constraint_genes_best_score": "HCNDD DOM+XL\n(constrained)",
    "del_sparksfari1_constraint_genes_best_score":              "SPARK SFARI\n(constrained)",
    "del_eagles_ds_constraint_genes_best_score":                "EAGLE\n(constrained)",
    "del_syngo_constraint_genes_best_score":                    "SynGO\n(constrained)",
    "del_chromepitf_constraint_genes_best_score":               "ChromEpiTF\n(constrained)",
    "del_metabolic_constraint_genes_best_score":                "Metabolic\n(constrained)",
    "del_syngo_chromepitf_constraint_genes_best_score":         "SynGO+ChromEpiTF\n(constrained)",
    # del all
    "del_proteinconding_genes_best_score":                      "Protein coding",
    "del_hcndddomv6_xlinked_boyz_genes_best_score":            "HCNDD DOM+XL",
    "del_sparksfari1_genes_best_score":                         "SPARK SFARI",
    "del_eagles_ds_genes_best_score":                           "EAGLE",
    "del_syngo_genes_best_score":                               "SynGO",
    "del_chromepitf_genes_best_score":                          "ChromEpiTF",
    "del_metabolic_genes_best_score":                           "Metabolic",
    "del_syngo_chromepitf_genes_best_score":                    "SynGO+ChromEpiTF",
}
...
def load_data():
    print(f"Loading carrier annotations (hg38): {CARRIER_HG38}")
...
def main():
    ...
    for subset_name, cols in LOEUF_COLS.items():
        ...
        print(f"\n=== hg38 {subset_name} ({len(cols_exist)} gene lists) ===")
