#!/usr/bin/env python3
# =============================================================================
# hg38/gnomAD v2 Carrier Annotation from Raw Data (legacy -- superseded by gnomAD v4)
# =============================================================================
...
# not produced here. 5_hg38_carrier_freq_or.py gracefully skips missing columns.
#
...
# Import helpers from script 1
from importlib.util import spec_from_file_location, module_from_spec
_script_dir = os.path.dirname(os.path.abspath(__file__))
_spec = spec_from_file_location("script01", os.path.join(_script_dir, "1_carrier_annotation.py"))
...
def main():
    ...
    # ================================================================
    # 6. Process DELETIONS (same pipeline as hg19 script 1)
    # ================================================================
