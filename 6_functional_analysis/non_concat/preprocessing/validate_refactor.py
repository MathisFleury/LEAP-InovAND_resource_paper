...
`6_functional_analysis/non_concat/preprocessing/outputs/df_conn_cohort_norm.csv`.
...
Outputs land under:
    6_functional_analysis/non_concat/preprocessing/outputs_validate_refactor/
...
def main() -> None:
    ...
    print("\n✓ comparison complete  →  6_functional_analysis/non_concat/preprocessing/outputs_validate_refactor/")
